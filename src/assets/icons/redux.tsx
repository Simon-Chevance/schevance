const ReduxIcon = ({width, height}) => (
        ...
        >
            ...
            <path
                id="path2"
                d="M58.7 34C52.5 26.8 43.4 22.8 33 22.8h-1.3c-.7-1.5-2.3-2.4-4-2.4h-.2c-2.5 0-4.5 2.1-4.4 4.6.1 2.4 2.1 4.4 4.6 4.4h.2c1.8-.1 3.3-1.2 4-2.8h1.5c6.2 0 12.1 1.8 17.3 5.3 4.1 2.7 7 6.2 8.6 10.4 1.4 3.4 1.3 6.8-.2 9.6-2.3 4.3-6.1 6.7-11.2 6.7-3.3 0-6.4-1-8-1.7-.9.8-2.5 2.1-3.7 2.9 3.5 1.6 7.1 2.5 10.5 2.5 7.8 0 13.6-4.3 15.8-8.6C65 49 64.8 40.9 58.7 34"
                className="st0"
            />
            <path
                id="path3"
                d="M17.3 45.4c.1 2.4 2.1 4.4 4.6 4.4h.1c2.5-.1 4.5-2.2 4.4-4.7-.1-2.4-2.1-4.4-4.6-4.4h-.2c-.2 0-.4 0-.6.1-3.3-5.5-4.7-11.6-4.2-18.1.3-4.9 2-9.1 4.8-12.6 2.4-3 6.9-4.5 10-4.6 8.8-.1 12.4 10.6 12.7 14.9 1.1.2 2.9.8 4.1 1.2-1-13.2-9.1-20-16.9-20-7.3 0-14.1 5.3-16.8 13.1C11 25.1 13.4 35.1 18 43c-.5.6-.8 1.5-.7 2.4"
                className="st0"
            />
        </svg>
);
